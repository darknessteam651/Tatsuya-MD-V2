 ...
 if (teks == 'edukasi') tags = {
  ...
  try {
      ...
      const sections = [
   {
	title: `Setatus`,
	rows: [
	    {title: `INFO BOT`, rowId: ".info", description: "Info nya Botzka"},
	    {title: `Pemilik Bot`, rowId: ".owner", description: "Owner disini"},
	{title: `Request Fitur`, rowId: ".request", description: "Request Fitur menarik ke BOT"},
	{title: `Bot Stats`, rowId: ".botinfo", description: "Menampilkan Status Botzka"},
	{title: `Test Speed`, rowId: ".testspeed", description: "Test Install Speed BOT"},
	{title: `Speed`, rowId: ".speed", description: "Kecepatan Respon Botzka..."},
	]
    },{
	title: `Category`,
	rows: [
	    {title: `Sewa BOT`, rowId: ".sewabot", description: "Menampilkan list harga sewa BOT"},
	    {title: `Kosong `, rowId: "p", description: "....."},
	...
	title: `Llist Menu`,
	rows: [
	    {title: `SEMUA PERINTAH`, rowId: ".? all", description: "Semua fitu ada disini"},
	...
	{title: `Anime`, rowId: ".? anime", description: "Lah, Wibuu"},
	...
	{title: ` Fitur Premium`, rowId: ".? premium", description: "Hanya khusus users premium.."},
	{title: `Anonymous chat `, rowId: ".? anonymous", description: "Mau ngomong sama mantan kah?"},
	{title: `Islamic`, rowId: ".? quran", description: "Tibat ya kak..."},
	...
	{title: `Group`, rowId: ".? group", description: "Menu settingan buat group mu kak"},
	...
	{title: `️️Info`, rowId: ".? info", description: "Info lowker kak?.."},
	{title: `fitur owner`, rowId: ".? owner", description: "Yg bukan developer gausah nge klik fitur ini !"},
	{title: `Maker`, rowId: ".? maker", description: "Bikin logo apa ya enaknya?"},
	{title: `Store`, rowId: ".? store", description: "Anak jebeh ya kamu kak?"},
	{title: `Virtex`, rowId: ".? virus", description: "Jangan Di pake yg aneh.."},
	]
    },{
	title: `info`,
	rows: [
	  ...
	  {title: `Group Botzka`, rowId: ".groupbot", description: 'Jangan lupa mampir ya...'},
...
let tek = `
 ...
 ┌──〔  𝐃𝐀𝐓𝐀𝐁𝐀𝐒𝐄  〕───⬣ 
 │⬡ Uptime : ${mpt}
 │⬡ user terdaftar :  *${Object.values(global.db.data.users).filter(user => user.registered == true).length}*
